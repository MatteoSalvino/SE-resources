 ...
 * 
 */
@WebServiceClient(name = "WSImplService", targetNamespace = "http://_soap_server.mycompany.com/", wsdlLocation = "http://localhost:8080/Exam-2019-06-11_SOAPWS/ProfessorManagement?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSIMPLSERVICE_QNAME = new QName("http://_soap_server.mycompany.com/", "WSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Exam-2019-06-11_SOAPWS/ProfessorManagement?wsdl");
    ...
    public WSInterface getWSImplPort() {
        return super.getPort(new QName("http://_soap_server.mycompany.com/", "WSImplPort"), WSInterface.class);
    }
    ...
    public WSInterface getWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://_soap_server.mycompany.com/", "WSImplPort"), WSInterface.class, features);
    }
