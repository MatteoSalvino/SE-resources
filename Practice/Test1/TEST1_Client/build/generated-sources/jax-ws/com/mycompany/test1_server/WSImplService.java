 ...
 * 
 */
@WebServiceClient(name = "WSImplService", targetNamespace = "http://test1_server.mycompany.com/", wsdlLocation = "http://localhost:8080/WSInterface?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WSIMPLSERVICE_QNAME = new QName("http://test1_server.mycompany.com/", "WSImplService");
    ...
    public WSInterface getWSImplPort() {
        return super.getPort(new QName("http://test1_server.mycompany.com/", "WSImplPort"), WSInterface.class);
    }
    ...
    public WSInterface getWSImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://test1_server.mycompany.com/", "WSImplPort"), WSInterface.class, features);
    }
